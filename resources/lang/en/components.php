...
return [
    ...
    'files' => [
        ...
        'type_size' => 'PNG, JPG up to :size MB',
        'type_size_kb' => 'PNG, JPG up to :size KB',
        'fix_type_size_kb' => ':type up to :size KB',
        'banner_image' => '350px width 214px height size between 50kb to 150kb',
        'slider_image' => '1350px width 420px height size between 50kb to 300kb',
        'uploading' => 'Uploading...',
    ],
