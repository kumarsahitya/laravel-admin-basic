...
return [
    ...
    'initialization' => [
        ...
        'step_2_description' => 'Ne vous inquiétez pas. Vous pouvez modifier ces paramètres à tout moment. Web Wireframe vous permet de commencer par le plus petit niveau afin que vous puissiez voir l\'évolution de votre boutique.',
    ...
    'roles_permissions' => [
        ...
        'login_information_summary' => "Ces informations seront utiles à l'administrateur pour se connecter à l'administration de Web Wireframe.",
    ...
    'seo' => [
        ...
        'description' => 'Améliorez votre classement et la façon dont votre page d\'entreprise apparaîtra dans les résultats des moteurs de recherche.',
    ],
