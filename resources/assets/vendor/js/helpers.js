...
const Helpers = {
    ...
    /**
     * Init country code selection for phone number
     * @param element
     */
    internationalNumber(element) {
        const phoneNumber = document.querySelector(element);
        var iti = intlTelInput(phoneNumber, {
            nationalMode: true,
            initialCountry: "auto",
