<div>
    <x-admin::breadcrumb :back="route('admin.settings.index')">
        <svg class="shrink-0 h-5 w-5 text-secondary-400" fill="currentColor" viewBox="0 0 20 20">
            <path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd"/>
        </svg>
        <a href="{{ route('admin.settings.index') }}" class="text-secondary-500 hover:text-secondary-700 focus:outline-none focus:underline transition duration-150 ease-in-out">
            {{ __('words.settings') }}
        </a>
    </x-admin::breadcrumb>
        ...
        <div class="rounded-md shadow overflow-hidden bg-white">
            ...
            <div class="bg-secondary-50 grid grid-cols-2">
                @if($github)
                    ...
                    <a href="{{ route('admin.settings.integrations.github') }}" class="inline-flex items-center border-l border-secondary-100 text-center py-3 px-4 text-secondary-700 leading-6 text-base font-medium sm:text-sm sm:leading-5 hover:text-secondary-500 focus:outline-none focus:text-secondary-900 transition duration-150 ease-in-out">
                        {{ __('Getting Started') }}
        ...
        <div class="rounded-md shadow overflow-hidden bg-white">
            ...
            <div class="bg-secondary-50 grid grid-cols-2">
                @if($twitter)
                    ...
                    <a href="{{ route('admin.settings.integrations.twitter') }}" class="inline-flex items-center border-l border-secondary-100 text-center py-3 px-4 text-secondary-700 leading-6 text-base font-medium sm:text-sm sm:leading-5 hover:text-secondary-500 focus:outline-none focus:text-secondary-900 transition duration-150 ease-in-out">
                        {{ __('Getting Started') }}
                        <svg class="h-5 w-5 ml-2 -mr-0.5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3" />
                        </svg>
    ...
    <x-admin::modal wire:model="confirmModalActivation" id="modal-enable" maxWidth="lg">
        <div class="px-4 pt-5 pb-4 sm:p-6">
            ...
            <div class="mt-4 sm:flex">
                <x-admin::buttons.primary wire:click="enableProvider" type="button" wire:loading.attr="disabled" class="capitalize w-full sm:w-auto sm:text-sm">
                    <x-admin::loader wire:loading wire:target="enableProvider" class="text-white" />
                    {{ __('Enable :provider', ['provider' => $currentProvider]) }}
                </x-admin::buttons.primary>
                <x-admin::buttons.secondary wire:click="closeIntegrationModal" class="mt-3 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
