...
>
    <x-admin::breadcrumb>
        ...
        <x-admin::breadcrumb.link :link="route('admin.settings.index')" :title="__('words.settings')"
                                  class="text-muted"/>
        <x-admin::breadcrumb.link :link="route('admin.settings.attributes.index')" :title="__('words.attributes')"
                                  class="text-muted"/>
        <x-admin::breadcrumb.view
            :title="__($name)" class="active"/>
    </x-admin::breadcrumb>
    <div class="text-right">
        <div class="flex items-center space-x-4 justify-end">
            ...
            <x-admin::buttons.primary wire:click="store" type="button"
    ...
    <div class="space-y-10">
        @if($this->hasValues())
            <livewire:settings.attributes.values :attribute="$attribute"/>
        @endif
    </div>
</div>
