<div>
    <x-admin::breadcrumb>
        ...
        <x-admin::breadcrumb.link :link="route('admin.settings.inventories.index')" :title="__('words.locations')"
                                  class="text-muted"/>
        <x-admin::breadcrumb.view :title="__('pages/settings.location.add')" class="active"/>
    </x-admin::breadcrumb>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-12">
                            <div class="flex items-center justify-between">
                                <x-admin::label class="form-label" :value="__('layout.forms.label.description')" for="description"/>
