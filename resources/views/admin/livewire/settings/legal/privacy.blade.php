        ...
        <div class="col-md-4">
            <div class="px-4 sm:px-0">
                ...
                <h6 class="mt-4 card-subtitle text-muted">
                    {{ __('pages/settings.legal.summary', ['policy' => __('pages/settings.legal.privacy')]) }}
                </h6>
            </div>
        </div>
        <div class="col-md-8">
            <div class="card mb-4 mt-4">
                <div class="card-body">
                    <div class="row">
                        <div class="mb-3 col-md-12">
                            <div class="flex items-center justify-between">
                                ...
                                <span role="checkbox" tabindex="0" @click="on = !on" @keydown.space.prevent="on = !on"
                                      ...
                                      class="bg-secondary-200 relative inline-flex shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer">
                        ...
                        <x-admin::forms.group :label="__('layout.forms.label.content')" for="privacy-content"
