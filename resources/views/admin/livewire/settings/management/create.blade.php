<div>
    <x-admin::breadcrumb>
        <x-admin::breadcrumb.link :link="route('admin.dashboard')"
                                  :title="__('words.dashboard')"
                                  class="text-muted" />
        <x-admin::breadcrumb.link :link="route('admin.settings.index')"
        ...
        <x-admin::breadcrumb.view :title="__('pages/settings.roles_permissions.add_admin')"
                                  class="active" />
    </x-admin::breadcrumb>
                    ...
                    <div class="row mb-3 sm:pt-5">
                        ...
                        <div class="col-sm-8">
                            <div class="max-w-lg relative rounded-md shadow-sm">
                                <x-admin::forms.input wire:model.lazy="email"
                                                      id="email"
                                                      type="email"
                                                      autocomplete="off"
            ...
            <div class="card mb-4 shadow-md overflow-hidden">
                <div class="card-body">
                    <div class="row mb-3 sm:pt-5">
                        ...
                        <div class="col-sm-8">
                            <div class="max-w-lg relative rounded-md shadow-sm">
                                <x-admin::forms.input wire:model.lazy="first_name"
                                                      id="first_name"
                                                      type="text"
                                                      autocomplete="off"
                    ...
                    <div class="row mb-3 mt-6 sm:mt-5 sm:pt-5 sm:border-t sm:border-secondary-200">
                        ...
                        <div class="col-sm-8">
                            <div class="max-w-lg relative rounded-md shadow-sm">
                                <x-admin::forms.input wire:model.lazy="last_name"
                                                      id="last_name"
                                                      type="text"
                                                      autocomplete="off"
                    ...
                    <div class="row mb-3 mt-6 sm:mt-5 sm:pt-5 sm:border-t sm:border-secondary-200">
                        ...
                        <div class="col-sm-8">
                            <div class="max-w-lg rounded-md shadow-sm">
                                <x-admin::forms.input wire:model.lazy="phone_number"
                                                      type="tel"
                                                      id="phone_number"
                                                      autocomplete="off"
                                                      class="form-control {{ $errors->first('last_name') ? 'is-invalid' : '' }}" />
        ...
        <div class="col-md-12">
            ...
            <div class="card mb-4 shadow-md overflow-hidden">
                <div class="card-body">
                    <div>
                        <div role="group"
                             aria-labelledby="roles-lists">
                            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-baseline">
                                <div>
                                    <div class="text-base col-form-label leading-6 font-medium text-secondary-900 sm:text-sm sm:leading-5 dark:text-white"
                                         id="roles-lists">
    ...
    <div class="mt-6 pb-10">
        <div class="mt-5 pt-5 border-t border-secondary-200 dark:border-secondary-700">
            <div class="text-right">
                <x-admin::buttons.secondary class="mr-2"
                                            :link="route('admin.settings.users')">
