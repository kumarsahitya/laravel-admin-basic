...
<div class="col-lg-4 col-md-6 mb-4">
    ...
    >
        <div
            class="shrink-0 flex items-center justify-center h-10 w-10 rounded-md bg-primary-600 text-white sm:h-12 sm:w-12 ">
            <i class="{{ $menu['icon'] }} bx-sm"></i>
        </div>
        <div class="space-y-1">
            <p class="inline-flex items-center text-base leading-6 font-medium text-secondary-900 dark:text-white">
                ...
                @if(! $menu['route'])
                    <span
                        class="ml-2.5 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium leading-4 bg-primary-100 text-primary-800">
                    {{ __('layout.soon') }}
                </span>
                @endif
            </p>
