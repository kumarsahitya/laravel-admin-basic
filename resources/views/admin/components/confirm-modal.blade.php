...
>
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div
            ...
            class="inline-block bg-white rounded-lg px-4 pt-5 pb-4 sm:p-6 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full dark:bg-secondary-800"
            role="dialog"
            aria-modal="true"
        ...
        >
            ...
            <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                <span class="flex w-full rounded-md shadow-sm sm:ml-3 sm:w-auto">
                    <x-admin::buttons.primary wire:click="{{ $method }}" wire:loading.attr="disabled" type="button">
                        <x-admin::loader wire:loading wire:target="{{ $method }}" />
                        {{ __('layout.forms.label.confirm') }}
                    </x-admin::buttons.primary>
                </span>
                <span class="mt-3 flex w-full rounded-md shadow-sm sm:mt-0 sm:w-auto">
                    <x-admin::buttons.secondary @click="confirm = false;" type="button">
