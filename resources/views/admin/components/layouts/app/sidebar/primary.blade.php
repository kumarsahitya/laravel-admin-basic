<div class="flex flex-col justify-between bg-primary-800 text-center w-16">
    <div>
        <div class="px-2 bg-white">
            <a class="shrink-0 flex items-center justify-center p-2" href="{{ route('admin.dashboard') }}">
                <x-admin::brand class="h-8 w-auto" />
            </a>
        </div>
        <div class="h-full pt-5 pb-4 overflow-y-auto">
            <ul class="mt-5 px-2 space-y-2 flex flex-col items-center">
                <x-admin::menu.item
                    ...
                    x-tooltip.raw="{{ __('layout.sidebar.dashboard') }}"
                >
    ...
    <div class="shrink-0 flex flex-col items-center space-y-3 pb-4">
        ...
        >
            <span class="translate-x-0 dark:translate-x-5 relative inline-block h-5 w-5 rounded-full bg-white shadow transform ring-0 transition ease-in-out duration-200">
                ...
                <span class="hidden dark:flex dark:opacity-0 dark:ease-out dark:duration-100 absolute inset-0 h-full w-full items-center justify-center transition-opacity opacity-10 ease-in duration-200" aria-hidden="true">
                    <svg class="h-3 w-3 text-secondary-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        ...
        @can('access_setting')
            <a
                ...
                class="block p-2 text-base leading-6 font-medium rounded-md text-white hover:bg-primary-700 @if(request()->routeIs('admin.settings*')) bg-primary-700 @endif focus:outline-none focus:bg-primary-900 transition ease-in-out duration-150"
                x-tooltip.raw="{{ __('layout.account_dropdown.settings') }}"
            >
        ...
        <a
            ...
            x-tooltip.raw="{{ __('messages.dashboard.cards.doc_title') }}"
        >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
